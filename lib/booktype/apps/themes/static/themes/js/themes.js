...
(function (win, jquery, _) {
  ...
  win.booktype.editor.themes = (function () {
    ...
    var getStyleData = function () {
      ...
      // Values
      data.fontSizeH1 = jquery('.heading-size', $tab).data('slider').getValue();
    ...
    var styleUpdated = function () {
      ...
      var s = '  #contenteditor H1 { ' +
        ...
        '  } ' +
        '  #contenteditor P+P { ' +
        '    text-indent: <%= indentP %>em; ' +
        '  } ' +
        '  #contenteditor P, #contenteditor TD, #contenteditor LI { ' +
    ...
    var setTheme = function (themeName) {
      ...
      var styleURL = _.sprintf("%s/data/themes/%s/editor.css", win.booktype.baseURL, themeName);
    ...
    var initPanel = function ($tab) {      
      ...
      jquery('.heading-align label', $tab).removeClass('active');
      if (!_.isUndefined(+_customData.alighH1)) {
