...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'themes_usertheme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Book'])),
            ('custom', self.gf('django.db.models.fields.TextField')(default='{}')),
            ('active', self.gf('django.db.models.fields.CharField')(default='custom', max_length=32)),
        ))
        db.send_create_signal(u'themes', ['UserTheme'])


    def backwards(self, orm):
        # Deleting model 'UserTheme'
        db.delete_table(u'themes_usertheme')
    ...
    models = {
        ...
        u'themes.usertheme': {
            ...
            'active': ('django.db.models.fields.CharField', [], {'default': "'custom'", 'max_length': '32'}),
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.Book']"}),
            'custom': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
