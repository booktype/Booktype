...
(function (win, jquery) {
  ...
  jquery(function () {
    var url = jquery('#formsignin').attr('signin-href');
    var redirect = jquery('#formsignin').attr('signin-redirect');
    jquery('#formsignin').booktypeSignin({'url': url, 'redirect': redirect  });
  });

  jquery(function () {
      var url = jquery('#formregister').attr('register-href');
      var redirect = jquery('#formregister').attr('register-redirect');
      jquery('#formregister').booktypeRegister({'url': url, 'redirect': redirect });
    });
