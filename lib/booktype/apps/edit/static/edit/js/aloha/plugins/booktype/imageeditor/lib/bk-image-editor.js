  ...
  function (jQuery, PubSub) {
    ...
    function BkImageEditor(image, frame, editorWidth) {
      ...
      this._init = function () {
        ...
        var transformData = imEd.$image.attr('data-transform');
      ...
      this._recordTransformData = function () {
        ...
        imEd.image.setAttribute('data-transform',
                                JSON.stringify(data)
        );
        ...
        PubSub.pub('bk-image-editor.data-transform.updated', {
          'data': data
        });
    ...
    function scaleImages($container, toWidth) {
      ...
      jQuery('div.group_img div.image', $container).each(function () {
        ...
        var transformData = $image.attr('data-transform');
        ...
        if (_.isUndefined(transformData)) {
          ...
          transformData = $image.attr('data-transform');
        }
        ...
        // record updated data-transform
        $image.attr('data-transform', JSON.stringify(transformData));
