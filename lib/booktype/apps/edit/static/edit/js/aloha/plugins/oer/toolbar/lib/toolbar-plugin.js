        ...
        var changeHeading = function(evt) {
          ...
          if (foundStyle) {
            if (foundStyle.type == 'custom') {
              if (!_.isUndefined(foundStyle.remove)) {
...
//          h = $(el).parentsUntil('.aloha-editable').andSelf();
          ...
          var _foundStyle = _.find(_.filter(tagnames, function (elem) { return toolbar.settings.styles[elem].type === 'custom'; }), function (elem) {
          ...
          if (_.isUndefined(_foundStyle)) {
              _foundStyle = _.find(_.filter(tagnames, function (elem) { return toolbar.settings.styles[elem].type === 'formatting'; }), function (elem) {
                var style = toolbar.settings.styles[elem];
