                ...
                return Plugin.create("font", {                        
                        init: function() {
                                ...
                                jQuery.each(list_of_fonts.fontlist,function(cnt,el){
                                        html_list_fonts+="<li><a data-target='#' class='action font' data-tagname='"+list_of_fonts.fontpaths[el]+"' data-placement='bottom'>"+el+"</a></li>"
                                        });
                               ...
                               Aloha.bind('aloha-editable-created', function($event, editable) {
                                console.log("aloha-editable-created");
