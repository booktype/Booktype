                        ...
                        init: function() {
                               ...
                               jQuery(".contentHeader .btn-toolbar .font-dropdown").html(html_list_fonts);
                                jQuery(".contentHeader .btn-toolbar .font-dropdown a").on('click', function (event) {
                                    ...
                                    var font_selected = jQuery(event.currentTarget).text(); // what about other font names ???
                                    console.log('selected font ', font_selected);
                                    console.log("editable ", editable);
                                    console.log('-----------------------------------');
                                    console.log("****");
                                    //console.log(jQuery(".contentHeader .button .btn .btn-default .btn-sm .dropdown-toggle  .action .aloha-dialog .font").css());
                                    console.log(jQuery(".font").css("a"));
                                    //console.log(jQuery(".icon-font").css(""));
                                    console.log("****");
