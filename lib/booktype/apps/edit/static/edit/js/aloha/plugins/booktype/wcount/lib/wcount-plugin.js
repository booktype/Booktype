                                        ...
                                        var get_wordcount = function(callback) {
                                                booktype.sendToCurrentBook({"command": "word_count"}, 
                                                        function(data) {
                                                            console.log(data);
                                                            //outing the data
                                                            jQuery19("#elCount .modal-dialog .modal-content .modal-body .all_wcount").text(data.wcount);
                                                            jQuery19("#elCount .modal-dialog .modal-content .modal-body .all_charcount").text(data.charcount);
