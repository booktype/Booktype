define(
  ['aloha', 'aloha/plugin', 'jquery', 'jquery19', 'ui/ui', 'aloha/ephemera', 'block/block',
    'block/blockmanager', 'underscore', 'endnotes/block', 'toolbar/toolbar-plugin'],
  function (Aloha, Plugin, jQuery, jQuery19, UI, Ephemera, block, BlockManager, _, EndnotesBlock, toolbar) {
    "use strict";
    ...
    return Plugin.create('endnotes', {
      ...
      init: function () {
        ...
        UI.adopt('endnote-insert', null, {
          click: function () {
            ...
            if (!jQuery(range.limitObject).find('div.aloha-block-EndnoteBlock').length && !_.isUndefined($blockInstance)) { return; }
      ...
      makeClean: function (obj) {
        ...
        jQuery(obj).find('.aloha-block-EndnoteBlock').each(function () {
          ...
          // convert table-based data to list-based
