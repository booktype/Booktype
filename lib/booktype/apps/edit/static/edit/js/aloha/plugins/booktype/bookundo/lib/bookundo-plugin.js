               ...
               onEditableActivated: function (e, editable) {
                        ...
                        */
                        ...
                        if(myStack.stack.length > 1) {
                          ...
                          console.log(current_stack_position);
                            ...
                            /* Compare current chapter content to the last one in stash. Do not do snapshot if they are the same */
                            if(myStack.stack[current_stack_position].data === content.data) {
                                return;
                            }
                            console.log("not returning");
                        }

                        console.log('[BOOK UNDO] makingSnapshot = ', myStack.stack, current_stack_position);

                        if(current_stack_position<myStack.stack.length){
                          myStack.stack.push(content);
                          current_stack_position++;
                          console.log("presnapshot ",current_stack_position,myStack.stack.length);
                          console.log(myStack.stack[current_stack_position].data);
                        }
                },
                ...
                undo: function () {
                        ...
                        if(myStack.stack.length > 0) {
                            ...
                            var new_content = myStack.stack[current_stack_position];
                            ...
                            if(new_content.siblings.length > 0) {
                                ...
                                */
                                ...
                                if($node.length > 0) {
                                    ...
                                    //current_stack_position--;
                                    console.log("undo ",current_stack_position,myStack.stack.length);
                                }
                            }
                        }
                },
                ...
                redo: function () {
                        ...
                        if(current_stack_position+1 < myStack.stack.length) {

                              var range = Aloha.Selection.getRangeObject();

                                current_stack_position++;
                                console.log(current_stack_position);
                                var content = myStack.stack[current_stack_position];
                          ...
                          console.log("redo ",current_stack_position,myStack.stack.length);                          
                      },
