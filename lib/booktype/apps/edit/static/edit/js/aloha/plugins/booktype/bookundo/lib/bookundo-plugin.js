...
define(['require'],function (require) {
        ...
        plugin = Plugin.create('bookundo', {
                ...
                onSmartContentChanged: function(e, args) {
                    ...
                    // When typing after undo we need to take snapshot so ignoreMe should be set to false 
                    // but it's true since we are comming from undo .... What to do????
                ...
                onEditableCreated: function (e, editable) {
                    ignoreMe = false; // testing if writing after undo
                    // also set current stack position !!
...
//                        if(current_stack_position<stack_length-1){
