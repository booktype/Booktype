 ...
 */
define(
['aloha', 'jquery', 'aloha/plugin', 'ui/ui', 'PubSub', 'undo/vendor/undo', 'undo/vendor/diff_match_patch_uncompressed'],
function( Aloha, jQuery, Plugin, UI, PubSub) {
		...
		init: function () {
			...
			var EditCommand = Undo.Command.extend({
					...
					reset: function(val) {
						...
						Aloha.trigger('aloha-my-undo', {'editable': this.editable});
           ...
           UI.adopt('bookundo', null, {
              click: function() {        
              	that.undo();
              }
            });

           UI.adopt('bookredo', null, {
              click: function() {        
              	that.redo();
              }
            });
