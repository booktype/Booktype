...
define(
  ['aloha','aloha/plugin','ui/ui','ui/button','aloha/rangy-core','aloha/copypaste','toolbar/toolbar-plugin','jquery'],
  function (Aloha, Plugin, Ui, Button, rangy, CopyPaste, toolbar, $) {
        var plugin;
