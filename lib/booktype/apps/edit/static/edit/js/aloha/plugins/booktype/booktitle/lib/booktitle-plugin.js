...
//                                $element.append(jQuery('<span class="heading-2">'+booktype._('title_author_content', "Author's name")+'</span>'));
         ...
                    BlockManager.registerBlockType('TitleBlock', TitleBlock);
                    ...
                    PubSub.sub('aloha.selection.context-change', function(m){
                      ...
                      if($block.length > 0) {
                        toolbar.disableToolbar('insertImage');
                        toolbar.disableToolbar('insertLink');
                        toolbar.disableToolbar('table-dropdown');

                        toolbar.disableToolbar('alignLeft');
                        toolbar.disableToolbar('alignRight');
                        toolbar.disableToolbar('alignCenter');
                        toolbar.disableToolbar('alignJustify');

                        toolbar.disableToolbar('unorderedList');
                        toolbar.disableToolbar('orderedList');

                        toolbar.disableMenu('horizontalline');
                        toolbar.disableMenu('pbreak');

                        wasInHeading = true;
                      } else if(wasInHeading) {
                        toolbar.enableToolbar('insertImage');
                        toolbar.enableToolbar('insertLink');
                        toolbar.enableToolbar('table-dropdown');

                        toolbar.enableToolbar('alignLeft');
                        toolbar.enableToolbar('alignRight');
                        toolbar.enableToolbar('alignCenter');
                        toolbar.enableToolbar('alignJustify');

                        toolbar.enableToolbar('unorderedList');
                        toolbar.enableToolbar('orderedList');

                        toolbar.enableMenu('horizontalline');
                        toolbar.enableMenu('pbreak');
