  define(['aloha', 'aloha/plugin', 'jquery',  'jquery19', 'ui/ui', 'aloha/ephemera', 'block/block', 'block/blockmanager', 'underscore'], 
  		function(Aloha, Plugin, jQuery,  jQuery19, UI, Ephemera, block, BlockManager, _) {
...
//    				      	return postProcessFn();
                        ...
                        if(jQuery19('.heading-2', $element).length == 0)
                                $element.append(jQuery19('<span class="heading-2">'+booktype._('title_author_content', "Author's name")+'</span>'));

                        if(jQuery19('.heading-3', $element).length == 0)
                                $element.append(jQuery19('<span class="heading-3">'+booktype._('title_sub_heading_content', 'Sub heading content')+'</span>'));
