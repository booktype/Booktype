  ...
  function (Aloha, Plugin, jQuery, jQuery19, UI, Ephemera, block, BlockManager, _, PubSub, booktype, toolbar) {
    ...
    var SimpleTableBlock = block.AbstractBlock.extend({
      ...
      init: function ($element, postProcessFn) {
        jQuery($element).find('td, caption').each(function () {
          var $td = jQuery(this);
    ...
    var _initTables = function (editable) {
      ...
      $tables.wrap('<div class="aloha-table"></div>').parent().alohaBlock({
...
           
        ...
        UI.adopt('inserttable', null, {
          click: function () {
            ...
            if (caption.length > 0)
              caption = '<caption><p>' + caption + '</p></caption>';


            var $a = jQuery('<div class="aloha-table"><table>' + caption + '<tbody>' + html + '</tbody></table></div>');
            $a.alohaBlock({
              'aloha-block-type': 'SimpleTableBlock'
            });
      ...
      makeClean: function (obj) {
        jQuery('.aloha-block-SimpleTableBlock', jQuery(obj)).each(function () {
          ...
          jQuery('td, caption', $table).each(function () {
            var $td = jQuery(this);
