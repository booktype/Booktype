      ...
      var _toc = function() {
        ...
        var _show = function() {
          ...
          if(win.booktype.editor.isEnabledTab('toc', 'hold')) {
              var t2 = win.booktype.editor.createRightTab('hold-tab', 'big-icon-hold', 'Chapters on Hold');
              t2.onActivate = function() {
                  ...
                  var holdBtnGroup = "<div class=\"btn-toolbar float-right\"><div class=\"btn-group\">" + 
                      "<button id=\"expand\" class=\"btn btn-default btn-xs option-hold\" rel=\"tooltip\" data-placement=\"left\" data-original-title=\"Unhold\">" +
              ...
              if(jquery("#removeSection INPUT[name=understand]:checked").val() == 'on') {
                  ...
                  win.booktype.sendToCurrentBook({"command": "section_delete", 
                                                  ...
                                                  function() { 
                                                    ...
                                                    // Trigger event
                                                    var doc = win.booktype.editor.getChapterWithID(chapter_id);
