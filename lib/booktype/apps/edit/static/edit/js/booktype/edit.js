...
(function (win, jquery, _) {
  ...
  win.booktype.editor.edit = (function () {
    ...
    var _show = function () {
      ...
      // ICEJS TAB
      if (win.booktype.editor.isEnabledTab('edit', 'icejs') && jquery('#create-ice-tab').data('has-perm')) {
        // FIXME: we need custom big icon here
        var iceTab = win.booktype.editor.createRightTab('icejs-tab', 'big-icon-attachments');
    ...
    var _init = function () {
      ...
      Aloha.bind('aloha-editable-created', function (e, editable) {
        if (editable.obj.attr('id') === 'contenteditor') {
          ...
          jquery('body').tooltip({
            selector: '#contenteditor span.ins, #contenteditor span.del',
            title: function () {
