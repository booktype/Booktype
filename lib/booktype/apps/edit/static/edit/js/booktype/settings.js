    ...
    var SettingsRouter = Backbone.Router.extend({
      ...
      roles: function () {
        ...
        var _loadUsers = function () {
          $.get(win.booktype.baseURL + '/_api/' + win.booktype.apiVersion + '/books/' + win.booktype.currentBookID + '/users/')
        ...
        var _loadRoles = function () {
          $.get(win.booktype.baseURL + '/_api/' + win.booktype.apiVersion + '/roles/')
            .fail(function (response) {
              _settingsLoadFailHandler(response);
            })
            .done(function (response) {
              ...
              $('button[data-target="#changeRoles"]').on('click', function () {
                ...
                $changeRoleButton.on('click', function () {
                  ...
                  if (rolesToAssign.length) {
                    $.post(
                      win.booktype.baseURL + '/_api/' + win.booktype.apiVersion + '/books/' + win.booktype.currentBookID + '/grant-user/multi/',
                      {
                  ...
                  if (rolesToRemove.length) {
                    $.post(
                      win.booktype.baseURL + '/_api/' + win.booktype.apiVersion + '/books/' + win.booktype.currentBookID + '/remove-grant-user/multi/',
                      {
        ...
        // set menu as active
        $('li:has(a[href="#roles"])').addClass('active');
      },
