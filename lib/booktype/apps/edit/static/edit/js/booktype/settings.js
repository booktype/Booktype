  ...
  win.booktype.editor.settings = (function () {
    ...
    var _init = function () {
      ...
      $('#button-settings').on('click', function () {
        ...
        // open default option
        var defaultMenu = $('a[href="#language"]')[0];
        win.booktype.utils.triggerClick(defaultMenu);
      });
        ...
        $.ajax({
          ...
          success: function (resp) {
            if (resp.error) {
              ...
              Backbone.history.navigate('settings/' + setting, true);
      ...
      $(document).on('change', 'SELECT[name=license]', function () {
        ...
        var licenseList = win.booktype.licenseList;
