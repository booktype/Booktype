    ...
    var drawChapterEditLock = function (chapterItem, chapterTemplate) {
      ...
      if (chapterItem.isUnderEdit()) {
        ...
        if (!jquery(".edit-by", chapterTemplate).length) {
          ...
          label.append("&nbsp;" + chapterItem.get("editBy"));
          ...
          jquery(".btn-toolbar .toc-chapter-short-labels", chapterTemplate).prepend(profileLink);
          ...
          var detailProfileLink = jquery("<a>").attr({
            ...
            class: "edit-by",
            target: "_blank"
          }).html(icon.clone()).append("&nbsp;" + chapterItem.get("editBy"));
          // TODO remove this hardcoded div and hardcoded custom labels
          jquery(".toc-chapter-detail", chapterTemplate).prepend(jquery("<div class='edit-by'></div>").html(detailProfileLink));
        }
      } else {
