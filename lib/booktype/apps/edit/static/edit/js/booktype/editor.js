...
(function(win, jquery, _) {
	...
	win.booktype.editor = function() {				
		...
		var DEFAULTS = {
                       ...
                       tabs: {'icon_generator': function(tb) {
                                                      var tl = '';
                       ...
                       config: {                       	    
                       			...
                       			'edit': {
                       				...
                       				'toolbar': {'H': ['table-dropdown', 'unorderedList', 'orderedList'],
						                        ...
						                        'ALL': ['table-dropdown', 'alignLeft', 'alignRight',  'indent-left', 'indent-right',
							                            ...
							                            'heading-dropdown']},     
                       				'menu': {'H': ['insertImage', 'insertLink', 'horizontalline', 'pbreak'],
		...
		var hideAllTabs = function() {
          ...
          jquery('.left-tablist li').removeClass('active');          			
	   	...
	   	// Right tab
		var createRightTab = function(tab_id, iconID, title) {
		...
		// Left tab
		var createLeftTab = function(tab_id, iconID, title) {
			     var tb = new Tab(tab_id, iconID);
			     tb.isLeft = true;
