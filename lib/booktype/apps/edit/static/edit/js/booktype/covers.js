...
(function (win, jquery, _) {
  ...
  win.booktype.editor.covers = (function () {
    ...
    var CoverView = Backbone.View.extend({
      ...
      templItem: _.template('<div class="coverThumbnail" data-cid="<%= cid %>">\
         <div class="coverThumbnailImg">\
           ...
           <div class="coverInfo">\
             ...
             <div class="coverFileInfo">\
               <span class="coverFileName"><strong>' + booktype._('file_name', 'File name:') + '</strong> <%= filename %></span>\
               <span class="coverFileSize"><strong>' + booktype._('file_size', 'File size:') + '</strong> <%= size %></span>\
               <span class="coverFileDimensions"><strong>' + booktype._('image_dimensions', 'Image dimensions:') +'</strong> <%= dimension %></span>\
             </div>\
           </div>\
         </div>\
         <div class="coverOptions">\
           <input type="checkbox" id="<%= cid %>" name="cc" <%= approved ? "checked" : "" %> >\
           <label for="<%= cid %>"><span></span>'+ booktype._('approved','Approved') +'</label>\
           <div class="btn-group">\
             <button id="btnEditCover" class="btn btn-default btn-xs" rel="tooltip" title="" data-placement="bottom" data-original-title="'+ booktype._('edit_image_data','Edit Image Data') +'" data-toggle="modal" href="#editCover"><i class="icon-pencil"></i></button>\
             <a class="btn btn-default btn-xs" rel="tooltip" title="" data-placement="bottom" data-original-title="'+ booktype._('view_original_image','View Original Image') +'" href="<%= preview %>" target="_blank"><i class="icon-eye-open"></i></a>\
             <button id="btnDeleteCover" class="btn btn-default btn-xs" rel="tooltip" title="" data-placement="bottom" data-original-title="'+ booktype._('delete_cover_image','Delete Cover Image') +'"><i class="icon-trash"></i></button>\
           </div>\
         </div>\
       </div>'),
