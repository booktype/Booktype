    ...
    var CoverView = Backbone.View.extend({
      ...
      templItem: _.template('<div class="coverThumbnail" data-cid="<%= cid %>">\
         ...
         <div class="coverOptions">\
           ...
           <div class="btn-group">\
             <button id="btnEditCover" class="btn btn-default btn-xs" rel="tooltip" title="" data-placement="bottom" data-original-title="Edit Image data" data-toggle="modal" href="#editCover"><i class="icon-pencil"></i></button>\
             <a class="btn btn-default btn-xs" rel="tooltip" title="" data-placement="bottom" data-original-title="View Original Image" href="<%= preview %>" target="_blank"><i class="icon-eye-open"></i></a>\
             <button id="btnDeleteCover" class="btn btn-default btn-xs" rel="tooltip" title="" data-placement="bottom" data-original-title="Delete Cover Image"><i class="icon-trash"></i></button>\
           </div>\
         </div>\
       </div>'),
