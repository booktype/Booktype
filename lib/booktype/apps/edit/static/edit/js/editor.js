...
(function(win, jquery) {
	...
	win.booktype.editor = function() {				
		...
		var _initUI = function() {
            ...
            jquery("#button-toc").on('click', function(e) { showTOC(); });
            jquery("#button-media").on('click', function(e) { showMedia(); });
	        ...
	        win.booktype.editor.leftPanel('.left-tablist li #online-users-tab', function() {
	            console.log('klikno na chaptere');

	        });

	        win.booktype.editor.leftPanel('.left-tablist li #chat-tab', function() {
	            console.log('klikno na chaptere');
		...
		var _loadInitialData = function() {
		    ...
		    booktype.sendToCurrentBook({"command": "init_editor"},
									       function(data) {
									       		console.log(data);
									       		// Put this in the TOC
									       		chapters.loadFromArray(data.chapters);

									       		//chapters = data.chapters;
									       		holdChapters = data.hold;
		...
		var _initEditor = function() {
			// Initialize Panels
			panels = {'edit': eval('win.booktype.editor.edit'),
					  'toc' : eval('win.booktype.editor.toc'),					  
					  'media' : eval('win.booktype.editor.media'),					  					  
					 };	

			jquery.each(panels, function(i, v) { v.init(); });

			// initialize chapters
			chapters = new win.booktype.editor.toc.TOC();
			holdChapters = new win.booktype.editor.toc.TOC();
		...
		var rightPanel = function(name, callback) {
		...
		var leftPanel = function(name, callback) {
		        // left side
		        jquery(name).click(function() {
		            //close right side
