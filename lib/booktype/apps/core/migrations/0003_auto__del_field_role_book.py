...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Role.book'
        db.delete_column(u'core_role', 'book_id')


    def backwards(self, orm):
        # Adding field 'Role.book'
        db.add_column(u'core_role', 'book',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Book'], null=True, blank=True),
                      keep_default=False)
