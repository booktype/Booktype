...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Permission', fields ['app_name', 'name']
        db.create_unique(u'core_permission', ['app_name', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Permission', fields ['app_name', 'name']
        db.delete_unique(u'core_permission', ['app_name', 'name'])
