			    ...
			    $this.click(function() {
				    ...
				    var $d = $("<span/>").load(postURL, function() {				    
					    ...
					    $(".dialog", $d).dialog({"modal":    true,
							...
							"buttons": [{"text": win.booktype._('back', 'Back'),
								     "click": function() { 
								                 stepIndex -= 1;
							            ...
							            {"text": win.booktype._('create', 'Create'),
								     "click": function() { 
									    var $dialog = $(this);
									    var frm = $("FORM", dialog);
							            ...
							            {"text": win.booktype._('cancel', 'Cancel'),
								     "click": function() { 
									    $(this).dialog('close');
							              }
	  						            },

							            {"text": win.booktype._('next', 'Next'),
								     "click": function() { 
								                 stepIndex += 1;
						                                 showStep(dialog, stepIndex);
							     ...
							     "click": function() { 
								    ...
								    $.getJSON(postURL, {"q": "create", 
										   ...
										   if(data.created == true) {
										       ...
										       alert( win.booktype._('errorcreategroup', "Couldn't create a group!"));
										   }
									       });
						              }
  						            }
			    ...
			    var $d = $("<span/>").load(postURL, function() {
				    ...
				    $(".dialog", $d).dialog({"modal":    true,
						...
						"open": function(event, ui) {
						    ...
						    // must translate this
						    var values = {"epub": win.booktype._('msgepub', "enter epub URL"),
								  "archive": win.booktype._('msgarchive',"enter Archive.org ID"),
								  "wikibooks": win.booktype._('msgwiki', "enter Wikibooks URL"),
								  "booki": win.booktype._('msgbooktype', "enter Booktype URL")
						    };
						...
						"buttons": [
							     ...
							     "click": function() { 
						            ...
						            {"text":  win.booktype._('import', "Import"),
							     "click": function() { 
								    var $dialog = $(this);
								    var isHidden = '';
		    ...
		    $this.click(function() {
			    ...
			    var $d = $("<span/>").load(postURL, function() {				    
				    ...
				    $(".dialog", $d).dialog({"modal":    true,
						...
						"buttons": [{"text":  win.booktype._('cancel', "Cancel"),
							     "click": function() { 
							    $(this).dialog('close');
							      }
							     },
         
						            {"text": win.booktype._('savechanges', "Save changes"),
							     "click": function() { 
								    var $dialog = $(this);
								    var frm = $("FORM", dialog);
				    ...
				    $(".dialog", $d).dialog({"modal":    true,
						...
						"buttons": [{"text":  win.booktype._('cancel', "Cancel"),
							    ...
							    $(this).dialog('close');
						            ...
						            {"text": win.booktype._('deletebook', "Delete book"),
							     "click": function() { 
								    var $dialog = $(this);
								    var frm = $("FORM", dialog);
