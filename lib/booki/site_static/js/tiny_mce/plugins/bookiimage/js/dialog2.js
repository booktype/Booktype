var FileBrowserDialogue = {
	...
	s += '<input type="hidden" name="attachmenttab" value="2"/><input type="submit" value="Upload" /></form><iframe width="0" height="0" border="0" style="border: 0px; width: 0px; height: 0px;" name="hiddenupload"></iframe></span>';
	...
	var j = this.win.parent.jQuery;
        ...
        j.booki.sendToCurrentBook({"command": "attachments_list"},
				  function(data) {
				      ...
				      frm.html('<table border="0" width="100%"><tr><th><b>name</b></th><th><b>dimension</b></th><th><b>size</b></th><th><b>date</b></th></tr>'+s+'</table>');
				  });
