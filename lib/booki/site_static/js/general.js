		    ...
		    $this.click(function() {
			    ...
			    var $d = $("<span/>").load(postURL, function() {				    
				    ...
				    $(".dialog", $d).dialog({"modal":    true,
						...
						"buttons": [{"text": $.booki._('back', 'Back'),
							     "click": function() { 
							                 stepIndex -= 1;
							     ...
							     "click": function() { 
								    ...
								    $.getJSON(postURL, {"q": "create", 
										   ...
										   if(data.created == true) {
										       ...
										       alert( $.booki._('errorcreategroup', "Couldn't create a group!"));
										   }
									       });
						              }
  						            }
			    ...
			    var $d = $("<span/>").load(postURL, function() {
				    ...
				    $(".dialog", $d).dialog({"modal":    true,
						...
						"open": function(event, ui) {
						    ...
						    // must translate this
						    var values = {"epub": $.booki._('msgepub', "enter epub URL"),
								  "archive": $.booki._('msgarchive',"enter Archive.org ID"),
								  "wikibooks": $.booki._('msgwiki', "enter Wikibooks URL"),
								  "booki": $.booki._('msgbooktype', "enter Booktype URL")
						    };
				    ...
				    $(".dialog", $d).dialog({"modal":    true,
						...
						"buttons": [{"text":  $.booki._('cancel', "Cancel"),
							    ...
							    $(this).dialog('close');
						            ...
						            {"text": $.booki._('savechanges', "Save changes"),
							     "click": function() { 
								    var $dialog = $(this);
								    var frm = $("FORM", dialog);
