...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('editor_attachment', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'BookVersion.created'
        db.alter_column('editor_bookversion', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Chapter.created'
        db.alter_column('editor_chapter', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Attachment.created'
        db.alter_column('editor_attachment', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'BookVersion.created'
        db.alter_column('editor_bookversion', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Chapter.created'
        db.alter_column('editor_chapter', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
