...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PublishWizzard', fields ['book', 'user', 'wizz_type']
        db.create_unique('editor_publishwizzard', ['book_id', 'user_id', 'wizz_type'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'PublishWizzard', fields ['book', 'user', 'wizz_type']
        db.delete_unique('editor_publishwizzard', ['book_id', 'user_id', 'wizz_type'])
