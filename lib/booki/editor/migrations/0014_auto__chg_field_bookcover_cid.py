...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookCover.cid'
        db.alter_column('editor_bookcover', 'cid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))

    def backwards(self, orm):

        # Changing field 'BookCover.cid'
        db.alter_column('editor_bookcover', 'cid', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))
