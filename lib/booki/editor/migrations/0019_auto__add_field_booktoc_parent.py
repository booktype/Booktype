...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookToc.parent'
        db.add_column(u'editor_booktoc', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.BookToc'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookToc.parent'
        db.delete_column(u'editor_booktoc', 'parent_id')
