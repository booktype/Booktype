...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookSetting'
        db.create_table(u'editor_booksetting', (
        ...
        db.send_create_signal(u'editor', ['BookSetting'])


    def backwards(self, orm):
        # Deleting model 'BookSetting'
        db.delete_table(u'editor_booksetting')
