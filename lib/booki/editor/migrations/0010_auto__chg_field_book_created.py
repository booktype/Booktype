...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('editor_book', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Book.created'
        db.alter_column('editor_book', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
