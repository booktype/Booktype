...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookCover'
        db.create_table('editor_bookcover', (
            ...
            ('is_book', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_ebook', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_pdf', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('cover_type', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('creator', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
        ...
        db.send_create_signal('editor', ['BookCover'])


    def backwards(self, orm):
        # Deleting model 'BookCover'
        db.delete_table('editor_bookcover')
