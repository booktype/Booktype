...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookCover.cid'
        db.add_column('editor_bookcover', 'cid',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookCover.cid'
        db.delete_column('editor_bookcover', 'cid')
    ...
    models = {
        ...
        'editor.bookcover': {
            ...
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '2500'}),
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['editor.Book']", 'null': 'True'}),
            'cid': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '32'}),
